...
// 	while ((newlinePos = this->requestHeader.find("\n")) != std::string::npos)
// 	{
// 		line = this->requestHeader.substr(0, newlinePos);
...
// 			// this->requestHeader.set(keyValue); 
// 		}
// 		this->requestHeader = this->requestHeader.substr(newlinePos + 1, this->requestHeader.length());
// 	}
// }
// void	Request::parseBody(std::string body)
// {
// 	// if (this->requestHeader.header("Content-Type") == "application/x-www-form-urlencoded")
// 		// this->requestBody.set(body);
// 	// 	std::cout << "->" << body << "<-" << std::endl;
// 	// else if (this->requestLine.getMethode() == "GET" && this->requestHeader.header("Content-Type") == "application/x-www-form-urlencoded")
// 	// 	std::cout << "=>" << body << "<=" << std::endl;
