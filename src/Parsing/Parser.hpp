...
#ifndef KEYS
	#define KEYS "return autoindex method error_log index access_log error_page alias client_body_buffer_size client_max_body_size error_page listen location root server server_name try_files types "
#endif
